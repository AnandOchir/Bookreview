    ...
    return (<>
        <div className='flex flex-col justify-between navpad' style={{ height: 276, backgroundColor: '#391F00' }}>
            ...
            <div className='flex justify-center' style={{ color: 'white' }}>
                ©copyright blah blah no copypaste
            </div>
        </div>
    </>)
}